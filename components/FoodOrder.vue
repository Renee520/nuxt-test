        ...
        <div :class="`${prefixCls}-recommend__content`">
          <div class="recommend-item" v-for="(item, index) in selectRecommendFood(foodList)" :key="index">
            <div class="recommend-item__inner" v-if="item.recommend">
              <img @click="showFoodPanel(item)" src="~/static/imgs/food/recommend.webp" />
          ...
          >
            <div class="food-panel flex">
              <div class="header flex">
                <img src="~/static/imgs/food/recommend.webp" alt="">
                <div class="info">
      ...
      <div :class="`${prefixCls}-content`">
        <div class="inner-container">
          ...
          <div  ref="foodList" class="food-list" >
            <div ref="foodContent" class="food-list-wrap">
...
export default {
  ...
  methods: {
    ...
    clickToChangeSidebar(index) { // 点击改变侧边导航选中项
      ...
      // this.$refs.foodList.scrollTop = 0;
      // this.scrollHeight = -this.$refs.foodContent.children[index].offsetTop;
      let el = this.$refs.foodContent.children[index];
      this.foodsScroll.scrollToElement(el, 300);
    },
    scrollChangeMenu (e) { // 滚动改变菜单选项
      /*
          监听滚动：
            遍历菜单，对比目标元素i和滚动条高度，
      ...
      this.foodList.forEach((item, index) => { // 遍历寻找滚动区域对应的目标元素
        ...
        console.log(that.itemHeight, that.scrollTop);
    ...
    addFoods(food) { // 添加商品
      ...
      this.$store.dispatch('order/saveFoods', this.allFoods).then(
        () => {
